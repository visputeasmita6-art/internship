...
*/
// Sibling Relation
// nextSibling gives next node on same tree level
...
console.log(headElementNode.nextElementSibling);// this will give us body element node directly and skip text node in between.
